...
class SimAnneal(object):
    ...
    def p_accept(self, candidate_fitness):
        print('T: '+str(float(self.T)))
        print(str('{0:.30f}'.format(candidate_fitness - self.cur_fitness))+": "+str('{0:.30f}'.format((candidate_fitness - self.cur_fitness)/self.T))+": "+str('{0:.30f}'.format(math.exp(-abs(candidate_fitness - self.cur_fitness) / self.T))))
